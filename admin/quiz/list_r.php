<?php 
    ...
    $result = mysqli_query($con,"SELECT * FROM rounds inner join quizzes on rounds.quiz_id=quizzes.id");
?>
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Rounds List</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url() ?>admin/index.php">Dashboard</a></li>
									<li class="breadcrumb-item active">Rounds List</li>
								</ul>
							</div>
						</div>
					</div>
										...
										<table class="table table-stripped mb-0" id="table">
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <td><?php echo $row['display_till'];?></td>
                                                    <td>
                                                        <div class="dropdown dropdown-action">
                                                            <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item" href="<?php echo base_url()."admin/quiz/edit_r.php?id=".$row['id'];?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                                <a class="dropdown-item" href="#" onclick="delete_round(<?php echo $row['id']; ?>)" ><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
						...
						<div class="modal-content">
							<div class="modal-body">
								...
								<div class="modal-btn delete-action">
                                    <form action="<?php echo base_url()?>admin/quiz/delete_r.php" method="POST">
