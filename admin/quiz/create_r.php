<?php 
    ...
    if(isset($_POST['submit'])){
        $id = $_POST['quiz_id'];
        $dp = $_POST['display_on'];
        $dt = $_POST['display_till'];
        $result = mysqli_query($con,"INSERT INTO rounds(`quiz_id`,`display_on`,`display_till`) VALUES('$id','$dp','$dt')");
        if($result){
            header("Location: ".base_url()."admin/quiz/list_r.php");
        }
    } 
?>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Create Round</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url() ?>admin/index.php">Dashboard</a></li>
									<li class="breadcrumb-item active">Create Round</li>
								</ul>
							</div>
						</div>
					</div>
