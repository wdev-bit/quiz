          ...
          <div class="row mr-0 pr-0">
            <div class="col-12 mx-0 px-0">
                <div class="first-i-frame">
                    <iframe src="https://virtualmosaic.com/tdevents/jumbotron" style="border: 0; width:100%; height: 100%;" allow="autoplay;camera *;encrypted-media" allowusermedia allowfullscreen ></iframe>
                </div>
            </div>
          </div>
        </div>
